...
function DropDownCtrl(o){o.building={options:["NAAB","GLAB","STEM"],selected:"NAAB"},o.floor={options:["Building wide event","Floor 1","Floor 2","Floor 3","Floor 4","Floor 5","Floor 6"],selected:"Building wide event"},o.room={options:["Floor wide event","Room 109","Room 113","Room 115"],selected:"Floor wide event"}}angular.module("RDash").controller("DropDownCtrl",["$scope",DropDownCtrl]);
